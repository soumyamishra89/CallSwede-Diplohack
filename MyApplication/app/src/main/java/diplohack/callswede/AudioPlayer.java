...
public class AudioPlayer {
    ...
    public void playRingtone(){
        ...
        audioManager.setStreamVolume(AudioManager.STREAM_RING, maxVolume, 0 /*flags*/);

        Log.v("TEST: ", "" + audioManager.getRingerMode());
        // Honour silent mode
        switch (audioManager.getRingerMode()) {
            case AudioManager.RINGER_MODE_NORMAL:
                mPlayer = MediaPlayer.create(mContext, R.raw.kung_fu_panda_3);
